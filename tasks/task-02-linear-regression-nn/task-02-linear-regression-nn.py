...
def solve_linear_regression_nn(X_train, y_train, epochs=100, learning_rate=0.01):
    ...
    """
    # Define o modelo com uma camada densa (único neurônio) e entrada de dimensão 1
    model = keras.Sequential([
        keras.layers.Dense(1, input_shape=(1,))
    ])
    # Compila o modelo usando o otimizador SGD e a função de perda MSE
    model.compile(optimizer=keras.optimizers.SGD(learning_rate=learning_rate), loss='mse')
    # Ajusta o formato dos dados de entrada para (n_amostras, 1)
